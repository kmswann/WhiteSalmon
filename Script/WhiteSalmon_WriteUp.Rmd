...
```{r fig8, echo=FALSE,fig.width=7.25, fig.height=9, message=FALSE,include=TRUE,fig.cap=" Monthly LOESS curve fit to historic data (1941-2019 water years) on the White Salmon River. Vertical dashed line signifies Condit Dam removal."}
...
```{r fig9, fig.width = 7.25, fig.height=9, echo=FALSE,message=FALSE,include=TRUE,fig.cap="Monthly LOESS curve fit to 2004-2011 and 2012-2019 water years on the White Salmon River. Vertical dashed line signifies Condit Dam removal. "}
