...
ws.nov <- 
  ...
  labs(x="November", y="Discharge (cfs)")+
...
ws.dec <- 
  ...
  labs(x="December", y="Discharge (cfs)")+
...
ws.feb <- 
  ...
  labs(x="February", y="Discharge (cfs)")+
...
ws.sep <- 
  ...
  labs(x="September", y="Discharge (cfs)")+
